...
% To plot raw waveforms, set to 1
pflag=1;
...
% end
% events='080410'
% events=['080426';'080427';'080428';'080429';'080430'];
...
%         ordlst=['KSXB';'ME01';'YBH ';'ME03';'ME02';'KRMB';'B039';'ME04';'ME29';'ME09';'ME10';'ME30';'ME13';'KHBB';'ME27';'WDC ';'ME16';'ME24';'ME28';'ME08';'ME26';'ME12']
...
%         continue
%     else
%         fidl=fopen(['tt_',event,'_',lower(region),'.obs'],'a'); % a for append, w to overwrite
%     end
        fidl=fopen('dumdum2.obs','w'); % dummy file for testing
    ...
    for hr=0:23
        ...
        for kk=1:fix(3600/tinc)
            ...
            % Plot if desired, waveforms before filtering
            % -------------------------------------------------------------
            if pflag == 1
                secplot(ncomp,ecomp,0,11,ordlst,0,'N raw','E raw','', 2)
            end
            ...
            % MANUAL FILTERING
            % ------------------------------------------------------------
%             [b,a]=butter(2,[1.5 5.5]/(40/2),'bandpass');
% %             [b,a]=butter(4,[1 6]/(40/2),'bandpass');
...
%             end
            ...
            % -----------------------------------------------------------
            if pflag == 1
                secplot(newuk(1:new_ns,:),newuk(new_ns+1:end,:),0,10,newlst,hr*3600+tt,'','','', 2);
%                 pause;
            end
...
%             [detect,i1s,i2s,maxwin,structD,history]=lfedetect2(newuk,newlst,event,hr,tt,newtwin,history,dupflag);
